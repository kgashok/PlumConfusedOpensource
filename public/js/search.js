...
var $author$project$Search$tweetDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Search$Tweet,
	...
	return $elm$http$Http$get(
		{
			expect: A2(
				...
				$author$project$Search$GotTweets,
				$elm$json$Json$Decode$list($author$project$Search$tweetDecoder)),
...
var $author$project$Search$viewTweet = function (tweet) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('tweet')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('@' + tweet.screenName)
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text(tweet.timestamp)
							]))
					]))
			]));
};
var $author$project$Search$viewResults = function (model) {
	var _v0 = model.error;
	if (_v0.$ === 'Just') {
		var error = _v0.a;
		return A2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('search-box')
					]),
				_List_fromArray(
					[
						A2(
...
var $author$project$Search$main = $elm$browser$Browser$element(
	{
		init: $author$project$Search$init,
